...
2. Run `./tools/cli/scaffold.sh <template> <project-name>` if in the ArchitectOS repo. Otherwise generate the structure manually using `scaffolds/<template>/README.md` as the blueprint.
